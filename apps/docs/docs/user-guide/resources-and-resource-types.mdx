...
![Attachment metadata for resource documents](/screenshots/open-mercato-attachment-details.png)
...
- **Review tags, assignments, and extracted text** from the shared [Attachments](./attachments) library when files need follow-up outside the resource screen.
