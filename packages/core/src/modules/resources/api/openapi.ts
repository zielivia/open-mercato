...
const buildResourcesCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Resources',
...
export function createResourcesCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildResourcesCrudOpenApi(options)
}
