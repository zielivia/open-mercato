...
export type CustomerExistingAccountEmailCopy = {
  preview: string
  title: string
  body: string
  cta: string
...
export type CustomerExistingAccountEmailProps = {
  loginUrl: string
  copy: CustomerExistingAccountEmailCopy
}

export function CustomerExistingAccountEmail({ loginUrl, copy }: CustomerExistingAccountEmailProps) {
  return (
    <Html>
      <Head />
      ...
      <Body style={body}>
        <Container style={container}>
          <Section>
            ...
            <Text>
              <Link href={loginUrl} style={button}>{copy.cta}</Link>
            </Text>
...
export default CustomerExistingAccountEmail
