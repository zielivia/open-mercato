...
| 4 | **Textarea** | `@open-mercato/ui/primitives/textarea` | Multi-line text: description, notes, comments | Single-line (→ `Input`), rich text (→ `RichEditor`) | No CVA | min-h-[80px] | Via `<Label htmlFor>` | No changes |
