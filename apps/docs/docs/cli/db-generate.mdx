...
5. Updates the module snapshot file (`.snapshot-<project>.json`) used by MikroORM as the diff baseline for the next generation run.
6. Prints a summary such as `• auth: generated Migration20240214_auth` or `• directory: no changes`.
