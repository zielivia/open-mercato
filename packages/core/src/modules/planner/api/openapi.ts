...
const buildPlannerCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Planner',
...
export function createPlannerCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildPlannerCrudOpenApi(options)
}
