...
/**
 * TC-CRM-035b: Nested profile payload normalization for PUT people & companies
 *
 ...
 */
test.describe('TC-CRM-035b: Nested profile payload normalization', () => {
  // --- People ---
