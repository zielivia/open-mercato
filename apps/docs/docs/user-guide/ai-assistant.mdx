...
Open Mercato can use local OpenAI-compatible servers for typed AI agents. This is useful for development, demos, offline work, or testing open-weight Llama models before choosing a hosted provider.
...
```bash
OM_AI_PROVIDER=lm-studio
LM_STUDIO_API_KEY=lm-studio
LM_STUDIO_BASE_URL=http://localhost:1234/v1
OM_AI_MODEL=<the model id shown by LM Studio>
```
...
```bash
OM_AI_PROVIDER=ollama
OLLAMA_API_KEY=ollama
OLLAMA_BASE_URL=http://localhost:11434/v1
OM_AI_MODEL=llama3.3
```
