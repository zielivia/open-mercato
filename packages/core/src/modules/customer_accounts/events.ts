...
const events = [
  ...
  { id: 'customer_accounts.user.updated', label: 'Customer User Updated', entity: 'user', category: 'crud' },
  { id: 'customer_accounts.user.deleted', label: 'Customer User Deleted', entity: 'user', category: 'crud' },
  { id: 'customer_accounts.user.locked', label: 'Customer User Locked', entity: 'user', category: 'lifecycle' },
  { id: 'customer_accounts.user.unlocked', label: 'Customer User Unlocked', entity: 'user', category: 'lifecycle' },
  ...
  { id: 'customer_accounts.email.verified', label: 'Customer Email Verified', category: 'lifecycle' },
  { id: 'customer_accounts.password.reset', label: 'Customer Password Reset', category: 'lifecycle' },
  { id: 'customer_accounts.role.created', label: 'Customer Role Created', entity: 'role', category: 'crud' },
  { id: 'customer_accounts.role.updated', label: 'Customer Role Updated', entity: 'role', category: 'crud' },
